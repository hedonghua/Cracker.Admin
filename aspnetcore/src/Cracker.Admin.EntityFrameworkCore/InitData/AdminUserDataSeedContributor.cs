...
namespace Cracker.Admin.InitData
{
    public class AdminUserDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public AdminUserDataSeedContributor(IRepository<SysUser> userRepository, IRepository<SysRole> roleRepository, IRepository<SysUserRole> userRoleRepository, IConfiguration configuration)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            if (!userExist)
            {
                var user = new SysUser
                {
                    ...
                    IsEnabled = true,
                    Avatar = configuration["Oss:Domain"] + AdminConsts.AvatarFemale
                };
